...
const MovieDetail = () => {
  ...
  const { backdropUrl, posterUrl, formattedRuntime, releaseYear, directors, topCast } = movieData;
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="relative container mx-auto px-4 pt-20 pb-10 min-h-[70vh] sm:min-h-[80vh] flex flex-col justify-center">
          <div className="flex flex-col lg:flex-row gap-8 items-center lg:items-start max-w-7xl mx-auto">
            {/* Poster and Logo Section */}
            <div className="w-full max-w-[280px] lg:max-w-xs flex-shrink-0">
              ...
              <div className="mt-4">
                <LogoTitle
                  ...
                  title={movie.title}
                  type="movie"
                  className="w-full max-w-full h-auto max-h-16 object-contain"
                  fallbackClassName="text-lg font-bold text-white text-center"
                />
              </div>
              ...
              <div className="mt-4 lg:hidden">
                <Button
                  ...
                  className="w-full bg-primary hover:bg-primary/90 text-white gap-2 rounded-full px-6 py-3 text-base font-medium shadow-lg"
                  size="lg"
                >
            ...
            <div className="flex-1 text-center lg:text-left max-w-3xl">
              ...
              <div className="flex flex-wrap gap-4 mb-6 text-sm justify-center lg:justify-start">
              ...
              <div className="mb-6 max-w-2xl mx-auto lg:mx-0">
                ...
                <p className="text-base text-white/70 leading-relaxed">{movie.overview}</p>
              </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="flex flex-wrap gap-2 justify-center lg:justify-start">
                    {directors.map((director: any) => (
                      <span key={director.id} className="text-base text-white/70">
                        {director.name}
                      </span>
                    ))}
                  </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Button
                  onClick={handleWatchClick}
                  className="hidden lg:flex bg-primary hover:bg-primary/90 text-white gap-2 rounded-full px-8 py-6 text-lg font-medium shadow-lg"
                >
                  <Play size={20} className="fill-white" />
                  Watch Now
                </Button>
      ...
      {/* Cast section */}
      {topCast.length > 0 && (
        <div className="py-12 bg-gradient-to-b from-transparent to-black/30">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl font-bold mb-8 text-center lg:text-left text-white">
              Featured Cast
            </h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {topCast.map((person: Cast) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <h3 className="font-medium text-sm line-clamp-1 text-white">{person.name}</h3>
