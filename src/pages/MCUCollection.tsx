...
import { getMCUCollection } from '@/lib/api/collections';
...
const MCUCollection = () => {
  ...
  const { data: collection, isLoading, error } = useQuery({
    queryKey: ['mcu-collection'],
    queryFn: getMCUCollection,
    ...
    return (
      <div className="container mx-auto px-4 py-8 text-center">
        <div className="bg-black/40 backdrop-blur-md rounded-xl p-8 max-w-lg mx-auto">
          <h2 className="text-2xl font-bold mb-4">Could not load MCU collection</h2>
          <p className="text-muted-foreground mb-6">
            We encountered an error while trying to fetch the Marvel Cinematic Universe collection. Please try again later.
          </p>
