...
class InfiniteGridMenu {
  ...
  constructor(canvas: HTMLCanvasElement, items: any[], onActiveItemChange: (index: number) => void, onMovementChange: (isMoving: boolean) => void, onInit: ((instance: InfiniteGridMenu) => void) | null = null) {
    this.canvas = canvas;
    this.items = items || [];
  ...
  #initTexture() {
    ...
    Promise.all(
      ...
      images.forEach((img, i) => {
        ...
        ctx.drawImage(img as HTMLImageElement, x, y, cellSize, cellSize);
      });
...
export default function InfiniteMenu({ items = [] }: { items?: any[] }) {
